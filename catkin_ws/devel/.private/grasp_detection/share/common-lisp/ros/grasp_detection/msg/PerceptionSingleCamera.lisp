...
;//! \htmlinclude PerceptionSingleCamera.msg.html

(cl:defclass <PerceptionSingleCamera> (roslisp-msg-protocol:ros-message)
  ((camera_id
    :reader camera_id
    :initarg :camera_id
    :type cl:string
   ...
   (rgb_camera_pose
    :reader rgb_camera_pose
    :initarg :rgb_camera_pose
   ...
   (depth_camera_info
    ...
    :initform (cl:make-instance 'sensor_msgs-msg:CameraInfo))
   (depth_camera_pose
    :reader depth_camera_pose
    :initarg :depth_camera_pose
    :type geometry_msgs-msg:Pose
    :initform (cl:make-instance 'geometry_msgs-msg:Pose))
   (detections
    :reader detections
...
(cl:defclass PerceptionSingleCamera (<PerceptionSingleCamera>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <PerceptionSingleCamera>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'PerceptionSingleCamera)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name grasp_detection-msg:<PerceptionSingleCamera> is deprecated: use grasp_detection-msg:PerceptionSingleCamera instead.")))

(cl:ensure-generic-function 'camera_id-val :lambda-list '(m))
(cl:defmethod camera_id-val ((m <PerceptionSingleCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_detection-msg:camera_id-val is deprecated.  Use grasp_detection-msg:camera_id instead.")
  (camera_id m))

(cl:ensure-generic-function 'rgb_image-val :lambda-list '(m))
(cl:defmethod rgb_image-val ((m <PerceptionSingleCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_detection-msg:rgb_image-val is deprecated.  Use grasp_detection-msg:rgb_image instead.")
  (rgb_image m))

(cl:ensure-generic-function 'rgb_camera_info-val :lambda-list '(m))
(cl:defmethod rgb_camera_info-val ((m <PerceptionSingleCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_detection-msg:rgb_camera_info-val is deprecated.  Use grasp_detection-msg:rgb_camera_info instead.")
  (rgb_camera_info m))

(cl:ensure-generic-function 'rgb_camera_pose-val :lambda-list '(m))
(cl:defmethod rgb_camera_pose-val ((m <PerceptionSingleCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_detection-msg:rgb_camera_pose-val is deprecated.  Use grasp_detection-msg:rgb_camera_pose instead.")
  (rgb_camera_pose m))

(cl:ensure-generic-function 'depth_image-val :lambda-list '(m))
(cl:defmethod depth_image-val ((m <PerceptionSingleCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_detection-msg:depth_image-val is deprecated.  Use grasp_detection-msg:depth_image instead.")
  (depth_image m))

(cl:ensure-generic-function 'depth_camera_info-val :lambda-list '(m))
(cl:defmethod depth_camera_info-val ((m <PerceptionSingleCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_detection-msg:depth_camera_info-val is deprecated.  Use grasp_detection-msg:depth_camera_info instead.")
  (depth_camera_info m))

(cl:ensure-generic-function 'depth_camera_pose-val :lambda-list '(m))
(cl:defmethod depth_camera_pose-val ((m <PerceptionSingleCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasp_detection-msg:depth_camera_pose-val is deprecated.  Use grasp_detection-msg:depth_camera_pose instead.")
  (depth_camera_pose m))

(cl:ensure-generic-function 'detections-val :lambda-list '(m))
(cl:defmethod detections-val ((m <PerceptionSingleCamera>))
  ...
  (detections m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PerceptionSingleCamera>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'rgb_camera_pose) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'depth_camera_pose) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PerceptionSingleCamera>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'rgb_camera_pose) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'depth_camera_pose) istream)
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <PerceptionSingleCamera>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'rgb_camera_pose))
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'depth_camera_pose))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'detections) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PerceptionSingleCamera>))
  "Converts a ROS message object to a list"
  (cl:list 'PerceptionSingleCamera
    (cl:cons ':camera_id (camera_id msg))
    (cl:cons ':rgb_image (rgb_image msg))
    (cl:cons ':rgb_camera_info (rgb_camera_info msg))
    (cl:cons ':rgb_camera_pose (rgb_camera_pose msg))
    (cl:cons ':depth_image (depth_image msg))
    (cl:cons ':depth_camera_info (depth_camera_info msg))
    (cl:cons ':depth_camera_pose (depth_camera_pose msg))
