...
class Perception {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('cameras_data')) {
        this.cameras_data = initObj.cameras_data
      }
      else {
        this.cameras_data = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [cameras_data]
    // Serialize the length for message field [cameras_data]
    bufferOffset = _serializer.uint32(obj.cameras_data.length, buffer, bufferOffset);
    obj.cameras_data.forEach((val) => {
      bufferOffset = PerceptionSingleCamera.serialize(val, buffer, bufferOffset);
    });
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [cameras_data]
    // Deserialize array length for message field [cameras_data]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.cameras_data = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.cameras_data[i] = PerceptionSingleCamera.deserialize(buffer, bufferOffset)
    }
  ...
  static getMessageSize(object) {
    ...
    object.cameras_data.forEach((val) => {
      length += PerceptionSingleCamera.getMessageSize(val);
    });
  ...
  static datatype() {
    ...
    return 'grasp_detection/Perception';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '7f155fccc8dd22fa4fd237c07ac106c4';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cameras_data !== undefined) {
      resolved.cameras_data = new Array(msg.cameras_data.length);
      for (let i = 0; i < resolved.cameras_data.length; ++i) {
        resolved.cameras_data[i] = PerceptionSingleCamera.Resolve(msg.cameras_data[i]);
      }
    }
    else {
      resolved.cameras_data = []
    }
