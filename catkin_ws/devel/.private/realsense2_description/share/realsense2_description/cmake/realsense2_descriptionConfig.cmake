...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_description_SOURCE_PREFIX /ws/src/realsense-ros/realsense2_description)
  set(realsense2_description_DEVEL_PREFIX /ws/devel/.private/realsense2_description)
  ...
  set(realsense2_description_INSTALL_PREFIX /ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws/src/realsense-ros/realsense2_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /ws/devel/.private/realsense2_description/lib;/ws/devel/lib;/opt/ros/noetic/lib)
